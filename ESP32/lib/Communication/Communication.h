...
public:
    ...
    /**
     * @brief Conteúdo do último pacote recebido
     * 
     */
    static char LastReceivedPacketContent[255];

    /**
     * @brief Tenta se conectar em algum dispositivo
     * 
    ...
    /**
     * @brief Gera a rede que fornece conectividade pros slaves
     * 
     */
    ...
    static void UDPSendMessage(const char* Message, int Port);
     ...
     /**
     * @brief Lê mensagens UDP
     * 
     */
    static void UDPReadMessage(int Port);

    /**
     * @brief Pega numero de devices conectados a este
     * 
     */
    static int GetNumConectedDevices();
